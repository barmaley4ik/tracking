...
export default {
  ...
  data() {
    return {
      ...
      form: {
        name: this.car.name,
        vin: this.car.vin,
        image_auction:this.car.image_auction,
        image_taken_auction:this.car.image_taken_auction,
        image_in_stock:this.car.image_in_stock,
        image_delivered:this.car.image_delivered,
        image_left_to_client:this.car.image_left_to_client,
      },
      progress: 0,
      progressText: '',
      zipFilename: '',
  ...
  methods: {
    submit() {
      this.sending = true
      this.$inertia.put('/admin/cars/'+ this.car.id, this.form)
